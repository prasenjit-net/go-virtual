...
type Handler struct {
	...
	globalStore    *store.GlobalStore      // Phase 2: global key-value store
	sessionManager *store.SessionManager   // Phase 2: session manager
	archiveManager *archive.ArchiveManager // Archives
...
// SetStoreManager wires the Phase 2 GlobalStore and SessionManager into the handler.
