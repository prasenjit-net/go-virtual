...
export default function AIScriptModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/50">
            <div className="bg-white rounded-t-2xl sm:rounded-xl shadow-2xl w-full sm:max-w-2xl mx-0 sm:mx-4 flex flex-col"
                ...
                <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4 min-h-0">
                    {isEmpty && (
                        <div className="flex flex-col items-center justify-center py-8 text-center text-gray-400 space-y-3">
                            ...
                            <div>
                                <p className="font-medium text-gray-600">Describe what the script should do</p>
                                <p className="text-sm mt-1">You can refine it iteratively — the AI remembers the conversation</p>
                            </div>
                            <div className="text-xs bg-purple-50 border border-purple-200 rounded-lg px-4 py-3 text-left text-purple-800 w-full max-w-sm">
                                ...
                                {msg.role === 'user' ? (
                                    ...
                                    <div>
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            <span className="text-emerald-700 font-medium text-xs">Script generated</span>
                                            <button
                                        ...
                                        {expanded[idx] && (
                                            <pre className="mt-2 text-xs font-mono bg-gray-800 text-gray-100 rounded-lg p-3 overflow-x-auto whitespace-pre-wrap max-h-48 overflow-y-auto">
                                                {msg.content}
                                            </pre>
                                        )}
                                        {!expanded[idx] && (
